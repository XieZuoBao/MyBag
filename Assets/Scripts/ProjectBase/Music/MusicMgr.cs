...
{
    private string bgMusicGoName = "BgMusic";                           //背景音效组件依附对象(new出来的)的名称
    private AudioSource bgMusic;                                        //背景音乐组件
    private float bgValue = 1.0f;                                       //背景音乐音量大小

    private string soundGoName = "Sound";                               //音效组件依附的游戏对象(new出来的)的名称
    private GameObject soundGo;                                         //音效组件依附的游戏对象
    private List<AudioSource> soundList = new List<AudioSource>();      //音效集合
    private float soundValue = 1.0f;                                    //音效音量
