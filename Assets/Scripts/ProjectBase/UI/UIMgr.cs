...
{
    private string uiCanvasPath = "Prefabs/UI/Common/UICanvas";             //UICanvas预制路径
    private string bottomNodeName = "Bottom";                               //底层ui节点
    private string middleNodeName = "Middle";                               //中间层ui节点
    private string topNodeName = "Top";                                     //顶层ui节点
    private string systemNodeName = "System";                               //系统层(最上层)ui节点
    private Transform bottomTrans;
    private Transform middleTrans;
    private Transform topTrans;
    private Transform systemTrans;
    private Dictionary<string, UIBase> uiPanelDict = new Dictionary<string, UIBase>();
